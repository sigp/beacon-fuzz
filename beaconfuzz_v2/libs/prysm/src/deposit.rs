...
extern "C" {
    ...
    fn pfuzz_ssz_deposit(input_ptr: *mut u8, input_size: usize) -> bool;
}
...
pub fn ssz_deposit(input: &[u8]) -> bool {
    ...
    let res = unsafe { pfuzz_ssz_deposit(input_ptr, input_size) };
    res
}

pub fn process_deposit(beacon: &[u8], container: &[u8], post: &[u8], debug: bool) -> bool {
