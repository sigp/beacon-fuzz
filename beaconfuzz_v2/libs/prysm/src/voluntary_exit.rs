...
extern "C" {
    ...
    fn pfuzz_ssz_voluntary_exit(input_ptr: *mut u8, input_size: usize) -> bool;
}
...
pub fn ssz_voluntary_exit(input: &[u8]) -> bool {
    ...
    let res = unsafe { pfuzz_ssz_voluntary_exit(input_ptr, input_size) };
    res
}

pub fn process_voluntary_exit(beacon: &[u8], container: &[u8], post: &[u8], debug: bool) -> bool {
