...
pub struct ProposerSlashingTestCase<T: EthSpec> {
...
impl<T: EthSpec> ProposerSlashingTestCase<T> {
    ...
    pub fn process_proposer_slashing(mut self) -> Result<BeaconState<T>, BlockProcessingError> {
...
#[no_mangle]
pub extern "C" fn proposer_slashing_c(
    input_ptr: *mut u8,
    input_size: usize,
    output_ptr: *mut u8,
