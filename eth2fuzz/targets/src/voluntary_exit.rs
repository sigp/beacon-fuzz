...
pub struct VoluntaryExitTestCase<T: EthSpec> {
    pub pre: BeaconState<T>,
    pub voluntary_exit: SignedVoluntaryExit,
}
...
impl<T: EthSpec> VoluntaryExitTestCase<T> {
    ...
    pub fn process_voluntary_exit(mut self) -> Result<BeaconState<T>, BlockProcessingError> {
